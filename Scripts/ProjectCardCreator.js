...
function createElements() {
    ...
    addContent(projectName, projectLinks, projectDesc, projectImage);
    addToDOM(cardContainer);
}


function addContent(projectName, projectLinks, projectDesc, projectImage) {
